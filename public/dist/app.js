...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var About, App, Inbox, Link, React, ReactDom, Route, Router;
	...
	Inbox = React.createClass({displayName: "Inbox",
	  render: function() {
	    return React.createElement("div", null, React.createElement("div", {
	      "style": {
	        'background-color': 'black'
	      }
	    }), React.createElement("h1", null, "這是黑箱"));
	  }
	});

	App = React.createClass({displayName: "App",
	  render: function() {
	    return React.createElement("div", null, React.createElement("h1", null, "App"), React.createElement("nav", null, React.createElement("div", {
	      "style": {
